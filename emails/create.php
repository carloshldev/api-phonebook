...
$emails->contact_id = $data->contact_id;
    ...
    // if unable to create the emails, tell the user
    else{
        ...
        // tell the user
		echo json_encode(array("status" => "error", "code" => 0,"message"=> "Unable to create emails","document"=> ""));
    }
}
...
// tell the user data is incomplete
    ...
    // tell the user
	echo json_encode(array("status" => "error", "code" => 0,"message"=> "Unable to create emails. Data is incomplete.","document"=> ""));
}
?>
